...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-4">
      {/* Header + objectif editable */}
      <div className="flex items-center justify-between">
        <h1 className="playfair text-lg font-bold" style={{ color: 'var(--gold)' }}>Tableau de bord</h1>
        {editingTarget ? (
      ...
      {/* Progression bar — pas culpabilisante */}
      {nbJours > 0 && (
      ...
      {/* RYTHME DU BAR — CA par jour de la semaine */}
      {weekdays.length > 0 && (
        <div className="card !p-3">
